...
interface MultipleAutomaticInitializationWithInitializationViewModelsHandler {
    var viewModelsInitialization: () -> MutableMap<String, ViewModel>

    fun getInitializedViewModelByKey(viewModelStoreOwner: ViewModelStoreOwner, savedKey: String) : ViewModel {
        val viewModel = viewModelsInitialization.invoke()[savedKey] ?: throw NullPointerException(ERROR_MESSAGE_INITIALIZED_MAP_CONTAINS_NO_VIEWMODEL_WITH_THIS_KEY)
